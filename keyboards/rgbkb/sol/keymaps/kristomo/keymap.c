...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
   * | Ctrl |  Win |  Alt |  RGB | ADJ  | Space| PGUP |  | Enter| Space|      | PSCN |  Alt |  FN  | Ctrl |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------'
   *                                    | Space| PGDN |  | Enter| Space|
   *                                    `-------------'  `-------------'
   */
  [_QWERTY] = LAYOUT( \
    KC_GESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5, KC_MINS,  KC_EQL,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, M_BSDEL, \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, RGB_TOG,     ADJ,  KC_SPC,  KC_PGUP,  KC_ENT,  KC_SPC,      _______, KC_PSCR, KC_RALT,   FN,KC_RCTL, \
                                                  KC_SPC,  KC_PGDN,  KC_ENT,  KC_SPC \
  ),
  ...
  [_FN] = LAYOUT( \
    ...
    _______, _______, _______, RGB_MOD, _______, _______, _______, _______, _______, KC_MUTE, KC_MPLY, KC_MNXT, _______, _______, \
